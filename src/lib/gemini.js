...
exports.analyzeCalendarScreenshot = analyzeCalendarScreenshot;
exports.generateCalendarConfig = generateCalendarConfig;
 ...
 */
function imageToGenerativePart(base64Data, mimeType) {
    return {
        inlineData: {
            data: base64Data,
            mimeType,
 ...
 */
async function analyzeCalendarScreenshot(imageBase64, mimeType = 'image/png') {
 ...
 */
async function generateCalendarConfig(adminDescription, screenshotAnalysis) {
    const model = getGeminiModel();
 ...
 */
async function generateClarificationQuestions(adminDescription, currentConfig) {
    const model = getGeminiModel();
